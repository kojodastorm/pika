...
export default function Main() {
    ...
    const pickBackground = () => {
        return ( <>
            ...
            <
            input placeholder = "Enter hex value"
            type = "text"
    ...
    const RenderMaker = () => ( <
        ...
        <
        a href = "https://twitter.com/thelifeofrishi"
        target = "_blank"
    ...
    return ( <
        ...
        div className = "w-full lg:w-[calc(100%-350px)] py-5 lg:p-10 lg:pl-0 flex flex-col-reverse lg:flex-col items-center justify-center overflow-y-auto" > {
            blob?.src ? ( <>
                ...
                <
                div className = { `${options?.roundedWrapper} overflow-hidden shadow-xl duration-200 ease-in-out relative my-5` } >
                ...
                <
                label className = "flex flex-col items-center justify-center text-lg opacity-30 select-none max-w-[550px] rounded-2xl p-10 mt-20 text-center dark:text-white cursor-pointer border-2 border-dashed border-gray-400 hover:opacity-50 duration-300"

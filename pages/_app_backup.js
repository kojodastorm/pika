...
function MyApp({ Component, pageProps }) {
    return ( <
        ...
        <
        link rel = "canonical"
        href = "https://pika.rishimohan.me" / >
        <
        meta property = "og:type"
        content = "website" / >
        <
        meta property = "og:url"
        content = "https://pika.rishimohan.me" / >
        <
        ...
        crossOrigin = { true }
        /> <
        link href = "https://fonts.googleapis.com/css2?family=Mulish:wght@400;600;700;900&display=swap"
        rel = "stylesheet" /
        >
        <
